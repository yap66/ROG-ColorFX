...
Public Class STAND_ROG_RIGHT
    Dim VAL_LED_LEFT_RED = 0, VAL_LED_LEFT_GREEN = 0, VAL_LED_LEFT_BLUE = 0

    Private Sub STAND_ROG_RIGHT_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ROG_FORM.ARDUINO_CONNECT.Write("1,0,0,0,")
    ...
    Private Sub TIMER_1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TIMER_1.Tick
        ...
        ROG_FORM.ARDUINO_CONNECT.Write("1," & VAL_LED_LEFT_RED & "," & VAL_LED_LEFT_GREEN & "," & VAL_LED_LEFT_BLUE & ",")
